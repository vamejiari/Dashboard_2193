...
router.get('/:Codigo_Habilitacion',getMetaProduccion)

//CREAR UNA META
router.post('/',createMetaProduccion)

//ACTUALIZAR UNA META DE UNA VARIABLE REGISTRADA A UNA ENTIDAD
router.put('/:Codigo_Habilitacion/:Id_Variable_Produccion', updateMetaProduccion)

//ELIMINAR UNA META DE UNA ENTIDAD
router.delete('/:Codigo_Habilitacion/:Id_Variable_Produccion', deleteMetaProduccion)
